...
**Next.js 15**와 **TailwindCSS** 기반으로 구축되어 빠른 페이지 로딩과 직관적인 사용자 경험을 제공합니다.  
...
<img width="563" height="267" alt="image" src="https://github.com/user-attachments/assets/428b86a0-8f50-4054-8672-be8c3bf17a15" />
...
SSR 기반 렌더링을 통해 초기 로딩 속도를 개선하고,  
TailwindCSS와 Shadcn UI로 **반응형·일관된 디자인 시스템**을 구축했습니다.  
